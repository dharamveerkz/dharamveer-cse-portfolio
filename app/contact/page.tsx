    ...
    <section className="px-6 py-20 bg-gradient-to-br from-blue-900 to-blue-600 text-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          ...
          <div className="p-4 bg-white/10 border border-white/20 rounded-lg backdrop-blur-sm">
            <p className="text-xs text-blue-200 uppercase mb-1">Phone</p>            <a href={`tel:${contactDetails.phone}`} className="font-semibold hover:text-blue-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {techLinks.map((link, i) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 p-4 bg-white/10 border border-white/20 rounded-lg backdrop-blur-sm hover:bg-white/20 transition"
                >
            ...
            <div className="flex flex-wrap gap-3">
              {socialLinks.map((link, i) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-3 bg-white/10 border border-white/20 rounded-lg backdrop-blur-sm hover:bg-white/20 transition"
                >
